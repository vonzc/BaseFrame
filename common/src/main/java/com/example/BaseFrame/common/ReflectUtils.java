...
public class ReflectUtils {
     ...
     *
     * @see ReflectUtils#getClassName(Type)
     */
     ...
     * with {@link ReflectUtils#TYPE_CLASS_NAME_PREFIX}. This method will substring it, for it to be eligible
